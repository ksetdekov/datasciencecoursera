...
```
## Warning: RUB=X contains missing values. Some functions will not work if objects
...
## 2019-12-24    62.2687    62.3511   61.8894     62.2922            0
##            RUB=X.Adjusted
## 2019-12-17        62.4400
## 2019-12-18        62.4088
## 2019-12-19        62.6128
...
```
## Warning in to.period(x, "days", name = name, ...): missing values removed from
## data
```
